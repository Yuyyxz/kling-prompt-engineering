...
| [24-prompt-library.md](24-prompt-library.md) | 风格与氛围 prompt 库：105 种风格（经典艺术36/电影导演18/建筑空间18/网络美学-core系16/摄影17）+ 50 种氛围 = 155 条完整配方，**每条都带模型适配行**（Kolors/Qwen/Seedream），附模型适配层（三模型转换规则+示范） |
